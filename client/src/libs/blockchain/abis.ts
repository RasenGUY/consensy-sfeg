...
export const borrowAbi = [
  ...
  },
  {
    ...
    name: 'generateBorrowId',
    outputs: [{ name: 'borrowId', internalType: 'bytes32', type: 'bytes32' }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'gradientOne', internalType: 'string', type: 'string' },
          { name: 'gradientTwo', internalType: 'string', type: 'string' },
          { name: 'diameter', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
